...
export default function ProfileScreen() {
  ...
  const MENU_ITEMS = [
    { icon: "person-outline" as const, label: "Edit Profile", onPress: () => Alert.alert("Coming Soon") },
    ...
    { icon: "information-circle-outline" as const, label: "About", onPress: () => Alert.alert("FitTrack v1.0.0") },
  ];
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <GlassCard style={styles.profileCard}>
          ...
          <View style={styles.avatarRow}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={[styles.roleBadge, { backgroundColor: colors.primary + "20" }]}>
                <Text style={[styles.roleTxt, { color: colors.primary, fontFamily: "Inter_600SemiBold" }]}>
          ...
          <Text style={[styles.gymName, { color: colors.mutedForeground, fontFamily: "Inter_400Regular" }]}>
        ...
        <View style={styles.statsRow}>
          {[
            ...
            { label: "Weight", value: `${todayLog.weight ?? "--"}kg`, color: colors.purple },
          ].map((s) => (
            <View key={s.label} style={[styles.statBox, { backgroundColor: colors.card, borderColor: colors.border }]}>
              <Text style={[styles.statVal, { color: s.color, fontFamily: "Inter_700Bold" }]}>{s.value}</Text>
        ...
        <View>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.achieveList}>
            {ACHIEVEMENTS.map((a) => (
              <View key={a.label} style={[styles.achieveCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
                <View style={[styles.achieveIcon, { backgroundColor: a.color + "20" }]}>
                  <Ionicons name={a.icon} size={22} color={a.color} />
                </View>
                <Text style={[styles.achieveLabel, { color: colors.foreground, fontFamily: "Inter_500Medium" }]}>
                  {a.label}
                </Text>
              </View>
            ))}
              ...
              >
                <Text
                  style={[
                    styles.roleBtnTxt,
                    {
                      color: user?.role === r ? colors.primary : colors.mutedForeground,
                      fontFamily: user?.role === r ? "Inter_600SemiBold" : "Inter_400Regular",
                    },
                  ]}
                >
        ...
        <GlassCard style={styles.menuCard}>
          {MENU_ITEMS.map((item, idx) => (
            <TouchableOpacity
              ...
              style={[
                styles.menuItem,
                idx < MENU_ITEMS.length - 1 && { borderBottomWidth: 0.5, borderBottomColor: colors.border },
              ]}
            >
        ...
        >
          ...
          <Text style={[styles.logoutTxt, { color: colors.destructive, fontFamily: "Inter_600SemiBold" }]}>
            Logout
          </Text>
        </TouchableOpacity>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  achieveCard: { width: 100, alignItems: "center", padding: 14, gap: 8, borderRadius: 16, borderWidth: 1 },
